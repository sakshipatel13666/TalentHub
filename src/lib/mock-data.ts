...
export const WORKSHOPS = [
  ...
  {
    id: 'w3',
    title: 'Vocal Power: Singing Masterclass',
    ...
    duration: '2 Hours',
    rating: 4.8,
    image: 'https://picsum.photos/seed/singer-vocalist/600/400',
    participants: 8,
    maxParticipants: 15
  },
  {
    ...
    duration: '4 Hours',
    rating: 5.0,
    image: 'https://picsum.photos/seed/camera-photo/600/400',
    participants: 10,
    maxParticipants: 12
  },
  {
    id: 'w5',
    title: 'Mindful Vinyasa Flow Yoga',
    instructor: 'Anya Sokolov',
    category: 'Fitness',
    price: 'Free',
    date: 'Nov 15, 2024',
    duration: '1 Hour',
    rating: 4.9,
    image: 'https://picsum.photos/seed/gym-fitness/600/400',
    participants: 82,
    maxParticipants: 200
  },
  {
    ...
    duration: '2.5 Hours',
    rating: 4.6,
    image: 'https://picsum.photos/seed/digital-marketing-seo/600/400',
    participants: 25,
    maxParticipants: 50
  },
  {
    id: 'w7',
    title: 'Advanced CSS Layouts with Grid & Flex',
    ...
    duration: '3 Hours',
    rating: 4.8,
    image: 'https://picsum.photos/seed/programming-codes/600/400',
    participants: 15,
    maxParticipants: 25
  },
  {
    ...
    duration: '5 Hours',
    rating: 4.9,
    image: 'https://picsum.photos/seed/web-design-ui/600/400',
    participants: 5,
    maxParticipants: 10
  }
];
